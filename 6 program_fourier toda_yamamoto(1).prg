...
equation eq01.ls y y(-1) y(-2) x(-1) x(-2) c @trend y(-3) x(-3) sint0 cost0
freeze(tab01!k) eq01.wald c(5)=0,c(6)=0,c(7)=0,c(8)=0,c(9)=0,c(10)=0  
...
equation eq01.ls x y(-1) y(-2) x(-1) x(-2) c @trend y(-3) x(-3) sint0 cost0
freeze(tab02!k) eq02.wald c(5)=0,c(6)=0,c(7)=0,c(8)=0,c(9)=0,c(10)=0 
